...
public class VesControllerTest {
    ...
    public void startShouldReturnApplicationStartedMessage() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc.perform(get("/start")).andDo(print())
                .andExpect(status().isOk()).andReturn();
        // Expect(jsonPath("$.content").value("Application started"));
    ...
    public void stopShouldReturnApplicationStoppingMessage() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc.perform(get("/stop")).andDo(print())
                .andExpect(status().isOk()).andReturn();
        // .andExpect(jsonPath("$.content").value("Application will be stopped soon"));
