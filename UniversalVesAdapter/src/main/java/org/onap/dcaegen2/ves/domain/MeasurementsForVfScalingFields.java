...
public class MeasurementsForVfScalingFields {
    ...
    private List<AdditionalField_> additionalFields = null;
    ...
    @JsonProperty("additionalFields")
    public List<AdditionalField_> getAdditionalFields() {
        return additionalFields;
    }

    @JsonProperty("additionalFields")
    public void setAdditionalFields(List<AdditionalField_> additionalFields) {
