...
public class MobileFlowFields {
    ...
    private List<AdditionalField__> additionalFields = null;
    ...
    @JsonProperty("additionalFields")
    public List<AdditionalField__> getAdditionalFields() {
        return additionalFields;
    }

    @JsonProperty("additionalFields")
    public void setAdditionalFields(List<AdditionalField__> additionalFields) {
