...
public class DMaaPMRSubscriberImpl extends BaseDMaaPMRComponent implements DMaaPMRSubscriber {
    ...
    public DMaaPMRSubscriberResponse fetchMessages() {
    	...
    	if(subscriberConfig.getUserName().equals("null") || subscriberConfig.getUserPassword().equals("null") )
    	{
    		userName=null;
    		userPassword=null;
    		
    	}else{
        userName = subscriberConfig.getUserName();
        userPassword = subscriberConfig.getUserPassword();
    	}
