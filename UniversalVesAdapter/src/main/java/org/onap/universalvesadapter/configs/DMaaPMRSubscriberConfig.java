...
public final class DMaaPMRSubscriberConfig extends DMaaPMRBaseConfig {
    ...
    public static class Builder {
		...
		public Builder(@Nonnull String hostName,
            ...
            //prop.setProperty("mr.DEFAULT_SUBSCRIBER_TIMEOUT_MS", prop.getProperty("mr.DEFAULT_SUBSCRIBER_TIMEOUT_MS");
            this.timeoutMS =dmaapConfig.getSubcriberDEFAULT_SUBSCRIBER_TIMEOUT_MS(); // defaults to 10ms timeout

            this.messageLimit = dmaapConfig.getSubcriberDEFAULT_SUBSCRIBER_MESSAGE_LIMIT(); // defaults to 1000 message limit
