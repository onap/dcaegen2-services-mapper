...
//number of retries when flushing messages
  ...
  //Dmaap Subcriber Topic
	...
	public String getDefaulMappingFileName() {
		return defaulMappingFileName;
	}

	public void setDefaulMappingFileName(String defaulMappingFileName) {
		this.defaulMappingFileName = defaulMappingFileName;
	}
